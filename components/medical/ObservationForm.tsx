...
import type { Observation, Vitals } from "@/lib/types";
...
export default function ObservationForm({ recordId, nurseId, nurseName, onAdded }: ObservationFormProps) {
  const t = useTranslations("nurse.observationForm");
  const tVitals = useTranslations("nurse.observationForm.vitals");
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
          ...
          <div>
            ...
            <input type="number" step="0.1" min="0" placeholder="36.6" value={temp} onChange={(e) => setTemp(e.target.value)} className={inputClass} />
          </div>
          <div>
