...
export default function PatientRecordsPage() {
  ...
  return (
    <SectionContainer title="Medical Records" description="Your nursing notes, observations, and care history from all visits.">
      ...
      <div className="space-y-4">
        {loading || loadingData ? (
          ...
          <div className="rounded-3xl border border-slate-100 bg-white p-10 text-center">
            ...
            <p className="font-semibold text-slate-700">No medical records yet</p>
            <p className="mt-1 text-sm text-slate-500">Records appear after your visits — your nurse will add notes and observations.</p>
          </div>
        ) : (
